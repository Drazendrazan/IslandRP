local WebhookEasyAdmin = 'https://discord.com/api/webhooks/872277768711319584/f-9NlpktwJKT2GGy8PQF_pC_3v28fD22t0XMTyIR_ieWhggYlRkbbhAo6JjhiNE3beY4'
local EasyAdminReportWebhook = 'https://discord.com/api/webhooks/872277768711319584/f-9NlpktwJKT2GGy8PQF_pC_3v28fD22t0XMTyIR_ieWhggYlRkbbhAo6JjhiNE3beY4'
...
AddEventHandler("kickAllPlayer2", function()
	...
	for i=1, #xPlayers, 1 do
		...
		DropPlayer(xPlayers[i], 'Restart Serwera - Zostałeś wyrzucony z serwera z powodu restartu, Poczekaj na ponownie włączenie serwera!')
...
Citizen.CreateThread(function()
	...
	RegisterCommand("report", function(source, args, rawCommand)
		...
		--local _source = source
		--local xPlayer = ESX.GetPlayerFromId(_source)
		--if xPlayer.group == 'superadmin' or xPlayer.group == 'admin' or xPlayer.group == 'best' or xPlayer.group == 'moderator' or xPlayer.group == 'support' or xPlayer.group == 'trailsupport' then
		for i,_ in pairs(OnlineAdmins) do 
		...
		TriggerClientEvent('chatMessage', source, "^1[REPORT]", {255,255,255}, GetLocalisedText("admincalled"))
