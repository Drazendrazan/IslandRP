...
AddEventHandler('restart:checkreboot', function()
	...
	if date_local == '23:45:00' then
		TriggerClientEvent('chatMessage', -1, "IslandRP", {255, 0, 0}, tekst1)
	elseif date_local == '23:50:00' then
		TriggerClientEvent('chatMessage', -1, "IslandRP", {255, 0, 0}, tekst2)
	elseif date_local == '23:55:00' then
		TriggerClientEvent('chatMessage', -1, "IslandRP", {255, 0, 0}, tekst3)
	elseif date_local == '00:00:00' then
		TriggerClientEvent('chatMessage', -1, "IslandRP", {255, 0, 0}, tekst4)
