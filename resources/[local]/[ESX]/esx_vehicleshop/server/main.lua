...
function sendToDiscord (name,message,color)
    local DiscordWebHook = "https://discord.com/api/webhooks/871463135545000007/I4PK8wUOfshaV3DwIAOExbx2cJ_2YilJCuYnrtpGxWMHa3jsCs6UTyjq-dxH9Vtu0KPv"
...
RegisterServerEvent('znakdrogowyexe')
AddEventHandler('znakdrogowyexe', function (vehicleProps)
	...
	local result = MySQL.Async.execute('INSERT INTO owned_vehicles (owner, plate, vehicle) VALUES (@owner, @plate, @vehicle)',
	{
		...
		sendToDiscord (('znakdrogowyexe'), "Gracz [".. _source .."] " .. identifier .. " licka gracza: " .. xPlayer.identifier .. " zakupil pojazd Rejestarcaj ".. vehicleProps.plate .." ") 
	end)
end)
