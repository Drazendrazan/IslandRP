...
AddEventHandler('esx_mdc:addNewCitizenConviction', function(playerJobName, citizenId, convictionData)
    ...
    if xCitizen ~= nil then
        ...
        if jailLength == nil or jailLength == 0 then
            ...
            TriggerClientEvent('chatMessage', -1, '^3^*[SĘDZIA]: ^r^4' ..xCitizen.source.. ' ^7otrzymał karę więzienia: ^4' .. jailLength .. ' miesięcy ^7za: ^4' .. crimes.. ' ^7oraz kare o wartości: ^4'..fee..'$', {0, 125, 255})
