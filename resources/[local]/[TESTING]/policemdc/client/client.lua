...
function startTabletAnimation()
	CreateThread(function()
	  ...
	  while not HasAnimDictLoaded(tabletDict) do
		...
		attachObject()
		TaskPlayAnim(Citizen.InvokeNative(0x43A66C31C68491C0, -1), tabletDict, tabletAnim, 8.0, -8.0, -1, 50, 0, false, false, false)
	end)
end
...
function stopTabletAnimation()
	if tabletEntity ~= nil then
		StopAnimTask(Citizen.InvokeNative(0x43A66C31C68491C0, -1), tabletDict, tabletAnim ,8.0, -8.0, -1, 50, 0, false, false, false)
